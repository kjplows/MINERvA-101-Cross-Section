#define MC_OUT_FILE_NAME "runEventLoopMC_warp_lowQ2PiTuneOn.root"
#define DATA_OUT_FILE_NAME "runEventLoopData_warp_lowQ2PiTuneOn.root"
...
int main(const int argc, const char** argv)
{
  ...
  MnvTunev1.emplace_back(new PlotUtils::LowQ2PiReweighter<UNIVERSE, EVENT>("JOINT"));
